...
public class RerRecipeProvider extends RecipeProvider implements IConditionBuilder {
	 ...
	 protected void buildRecipes(RecipeOutput recipeOutput) {
		  ...
		  List<ItemLike> PLATINUM_SMELTABLES = List.of(
					 RerMaterials.RAW_PLATINUM,
					 RerMaterialsBlocks.PLATINUM_ORE,
					 RerMaterialsBlocks.NETHERRACK_PLATINUM_ORE,
					 RerMaterialsBlocks.END_STONE_PLATINUM_ORE,
					 RerMaterialsBlocks.DEEPSLATE_PLATINUM_ORE,
					 RerMaterials.PLATINUM_DUST);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.PLATINUM_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.PLATINUM_BOLT.get())
					 .define('B', RerMaterials.PLATINUM_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.PLATINUM_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.PLATINUM_ROD.get())
					 .define('B', RerMaterials.PLATINUM_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.PLATINUM_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.PLATINUM_INGOT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.PLATINUM_DOUBLE_INGOT.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.PLATINUM_INGOT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PLATINUM_BOLT.get(), 2)
					 .requires(RerMaterials.PLATINUM_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PLATINUM_TINY_DUST.get(), 9)
					 .requires(RerMaterials.PLATINUM_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PLATINUM_DUST.get())
					 .requires(RerMaterials.PLATINUM_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PLATINUM_LARGE_PLATE.get())
					 .requires(RerMaterials.PLATINUM_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PLATINUM_CLUSTER.get())
					 .requires(RerMaterials.PLATINUM_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.RAW_PLATINUM.get(), 9)
					 .requires(RerMaterialsBlocks.RAW_PLATINUM_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.PLATINUM_BLOCK.get(), 1)
					 .requires(RerMaterials.PLATINUM_INGOT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.RAW_PLATINUM_BLOCK.get(), 1)
					 .requires(RerMaterials.RAW_PLATINUM, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PLATINUM_INGOT.get())
					 .requires(RerMaterials.PLATINUM_NUGGET, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput, "roprer:platinum_ingot_from_nugget");

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PLATINUM_NUGGET.get(), 9)
					 .requires(RerMaterials.PLATINUM_INGOT)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PLATINUM_INGOT.get(), 9)
					 .requires(RerMaterialsBlocks.PLATINUM_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_PLATINUM))
					 .save(recipeOutput);

		  oreSmelting(recipeOutput, PLATINUM_SMELTABLES, RecipeCategory.MISC, RerMaterials.PLATINUM_INGOT.get(), 0.2f, 200, "platinum");
		  oreBlasting(recipeOutput, PLATINUM_SMELTABLES, RecipeCategory.MISC, RerMaterials.PLATINUM_INGOT.get(), 0.2f, 100, "platinum");

		  List<ItemLike> URANIUM_SMELTABLES = List.of(
					 RerMaterials.RAW_URANIUM,
					 RerMaterialsBlocks.URANIUM_ORE,
					 RerMaterialsBlocks.NETHERRACK_URANIUM_ORE,
					 RerMaterialsBlocks.END_STONE_URANIUM_ORE,
					 RerMaterialsBlocks.DEEPSLATE_URANIUM_ORE,
					 RerMaterials.URANIUM_DUST);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.URANIUM_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.URANIUM_BOLT.get())
					 .define('B', RerMaterials.URANIUM_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.URANIUM_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.URANIUM_ROD.get())
					 .define('B', RerMaterials.URANIUM_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.URANIUM_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.URANIUM_INGOT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.URANIUM_DOUBLE_INGOT.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.URANIUM_INGOT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.URANIUM_BOLT.get(), 2)
					 .requires(RerMaterials.URANIUM_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.URANIUM_TINY_DUST.get(), 9)
					 .requires(RerMaterials.URANIUM_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.URANIUM_DUST.get())
					 .requires(RerMaterials.URANIUM_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.URANIUM_LARGE_PLATE.get())
					 .requires(RerMaterials.URANIUM_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.URANIUM_CLUSTER.get())
					 .requires(RerMaterials.URANIUM_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.RAW_URANIUM.get(), 9)
					 .requires(RerMaterialsBlocks.RAW_URANIUM_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.URANIUM_BLOCK.get(), 1)
					 .requires(RerMaterials.URANIUM_INGOT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.RAW_URANIUM_BLOCK.get(), 1)
					 .requires(RerMaterials.RAW_URANIUM, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.URANIUM_INGOT.get())
					 .requires(RerMaterials.URANIUM_NUGGET, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput, "roprer:uranium_ingot_from_nugget");

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.URANIUM_NUGGET.get(), 9)
					 .requires(RerMaterials.URANIUM_INGOT)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.URANIUM_INGOT.get(), 9)
					 .requires(RerMaterialsBlocks.URANIUM_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_URANIUM))
					 .save(recipeOutput);

		  oreSmelting(recipeOutput, URANIUM_SMELTABLES, RecipeCategory.MISC, RerMaterials.URANIUM_INGOT.get(), 0.2f, 200, "uranium");
		  oreBlasting(recipeOutput, URANIUM_SMELTABLES, RecipeCategory.MISC, RerMaterials.URANIUM_INGOT.get(), 0.2f, 100, "uranium");

		  List<ItemLike> SILVER_SMELTABLES = List.of(
					 RerMaterials.RAW_SILVER,
					 RerMaterialsBlocks.SILVER_ORE,
					 RerMaterialsBlocks.NETHERRACK_SILVER_ORE,
					 RerMaterialsBlocks.END_STONE_SILVER_ORE,
					 RerMaterialsBlocks.DEEPSLATE_SILVER_ORE,
					 RerMaterials.SILVER_DUST);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.SILVER_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.SILVER_BOLT.get())
					 .define('B', RerMaterials.SILVER_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.SILVER_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.SILVER_ROD.get())
					 .define('B', RerMaterials.SILVER_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.SILVER_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.SILVER_INGOT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.SILVER_DOUBLE_INGOT.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.SILVER_INGOT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SILVER_BOLT.get(), 2)
					 .requires(RerMaterials.SILVER_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SILVER_TINY_DUST.get(), 9)
					 .requires(RerMaterials.SILVER_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SILVER_DUST.get())
					 .requires(RerMaterials.SILVER_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SILVER_LARGE_PLATE.get())
					 .requires(RerMaterials.SILVER_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SILVER_CLUSTER.get())
					 .requires(RerMaterials.SILVER_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.RAW_SILVER.get(), 9)
					 .requires(RerMaterialsBlocks.RAW_SILVER_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.SILVER_BLOCK.get(), 1)
					 .requires(RerMaterials.SILVER_INGOT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.RAW_SILVER_BLOCK.get(), 1)
					 .requires(RerMaterials.RAW_SILVER, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SILVER_INGOT.get())
					 .requires(RerMaterials.SILVER_NUGGET, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput, "roprer:silver_ingot_from_nugget");

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SILVER_NUGGET.get(), 9)
					 .requires(RerMaterials.SILVER_INGOT)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SILVER_INGOT.get(), 9)
					 .requires(RerMaterialsBlocks.SILVER_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_SILVER))
					 .save(recipeOutput);

		  oreSmelting(recipeOutput, SILVER_SMELTABLES, RecipeCategory.MISC, RerMaterials.SILVER_INGOT.get(), 0.2f, 200, "silver");
		  oreBlasting(recipeOutput, SILVER_SMELTABLES, RecipeCategory.MISC, RerMaterials.SILVER_INGOT.get(), 0.2f, 100, "silver");

		  List<ItemLike> TITANIUM_SMELTABLES = List.of(
					 RerMaterials.RAW_TITANIUM,
					 RerMaterialsBlocks.TITANIUM_ORE,
					 RerMaterialsBlocks.NETHERRACK_TITANIUM_ORE,
					 RerMaterialsBlocks.END_STONE_TITANIUM_ORE,
					 RerMaterialsBlocks.DEEPSLATE_TITANIUM_ORE,
					 RerMaterials.TITANIUM_DUST);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.TITANIUM_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.TITANIUM_BOLT.get())
					 .define('B', RerMaterials.TITANIUM_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.TITANIUM_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.TITANIUM_ROD.get())
					 .define('B', RerMaterials.TITANIUM_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.TITANIUM_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.TITANIUM_INGOT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.TITANIUM_DOUBLE_INGOT.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.TITANIUM_INGOT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.TITANIUM_BOLT.get(), 2)
					 .requires(RerMaterials.TITANIUM_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.TITANIUM_TINY_DUST.get(), 9)
					 .requires(RerMaterials.TITANIUM_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.TITANIUM_DUST.get())
					 .requires(RerMaterials.TITANIUM_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.TITANIUM_LARGE_PLATE.get())
					 .requires(RerMaterials.TITANIUM_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.TITANIUM_CLUSTER.get())
					 .requires(RerMaterials.TITANIUM_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.RAW_TITANIUM.get(), 9)
					 .requires(RerMaterialsBlocks.RAW_TITANIUM_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.TITANIUM_BLOCK.get(), 1)
					 .requires(RerMaterials.TITANIUM_INGOT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.RAW_TITANIUM_BLOCK.get(), 1)
					 .requires(RerMaterials.RAW_TITANIUM, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.TITANIUM_INGOT.get())
					 .requires(RerMaterials.TITANIUM_NUGGET, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput, "roprer:titanium_ingot_from_nugget");

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.TITANIUM_NUGGET.get(), 9)
					 .requires(RerMaterials.TITANIUM_INGOT)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.TITANIUM_INGOT.get(), 9)
					 .requires(RerMaterialsBlocks.TITANIUM_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_TITANIUM))
					 .save(recipeOutput);

		  oreSmelting(recipeOutput, TITANIUM_SMELTABLES, RecipeCategory.MISC, RerMaterials.TITANIUM_INGOT.get(), 0.2f, 200, "titanium");
		  oreBlasting(recipeOutput, TITANIUM_SMELTABLES, RecipeCategory.MISC, RerMaterials.TITANIUM_INGOT.get(), 0.2f, 100, "titanium");

		  List<ItemLike> ZINC_SMELTABLES = List.of(
					 RerMaterials.RAW_ZINC,
					 RerMaterialsBlocks.ZINC_ORE,
					 RerMaterialsBlocks.NETHERRACK_ZINC_ORE,
					 RerMaterialsBlocks.END_STONE_ZINC_ORE,
					 RerMaterialsBlocks.DEEPSLATE_ZINC_ORE,
					 RerMaterials.ZINC_DUST);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.ZINC_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.ZINC_BOLT.get())
					 .define('B', RerMaterials.ZINC_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.ZINC_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.ZINC_ROD.get())
					 .define('B', RerMaterials.ZINC_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.ZINC_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.ZINC_INGOT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.ZINC_DOUBLE_INGOT.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.ZINC_INGOT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.ZINC_BOLT.get(), 2)
					 .requires(RerMaterials.ZINC_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.ZINC_TINY_DUST.get(), 9)
					 .requires(RerMaterials.ZINC_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.ZINC_DUST.get())
					 .requires(RerMaterials.ZINC_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.ZINC_LARGE_PLATE.get())
					 .requires(RerMaterials.ZINC_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.ZINC_CLUSTER.get())
					 .requires(RerMaterials.ZINC_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.RAW_ZINC.get(), 9)
					 .requires(RerMaterialsBlocks.RAW_ZINC_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.ZINC_BLOCK.get(), 1)
					 .requires(RerMaterials.ZINC_INGOT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.RAW_ZINC_BLOCK.get(), 1)
					 .requires(RerMaterials.RAW_ZINC, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.ZINC_INGOT.get())
					 .requires(RerMaterials.ZINC_NUGGET, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput, "roprer:zinc_ingot_from_nugget");

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.ZINC_NUGGET.get(), 9)
					 .requires(RerMaterials.ZINC_INGOT)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.ZINC_INGOT.get(), 9)
					 .requires(RerMaterialsBlocks.ZINC_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.RAW_ZINC))
					 .save(recipeOutput);

		  oreSmelting(recipeOutput, ZINC_SMELTABLES, RecipeCategory.MISC, RerMaterials.ZINC_INGOT.get(), 0.2f, 200, "zinc");
		  oreBlasting(recipeOutput, ZINC_SMELTABLES, RecipeCategory.MISC, RerMaterials.ZINC_INGOT.get(), 0.2f, 100, "zinc");

		  List<ItemLike> SAPPHIRE_SMELTABLES = List.of(
					 RerMaterials.SAPPHIRE_CLUSTER_SHARD,
					 RerMaterialsBlocks.SAPPHIRE_ORE,
					 RerMaterialsBlocks.NETHERRACK_SAPPHIRE_ORE,
					 RerMaterialsBlocks.END_STONE_SAPPHIRE_ORE,
					 RerMaterialsBlocks.DEEPSLATE_SAPPHIRE_ORE,
					 RerMaterials.SAPPHIRE_DUST);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SAPPHIRE_CLUSTER_SHARD.get(), 9)
					 .requires(RerMaterialsBlocks.SAPPHIRE_CLUSTER_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.SAPPHIRE_CLUSTER_BLOCK.get(), 1)
					 .requires(RerMaterials.SAPPHIRE_CLUSTER_SHARD, 9)
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.SAPPHIRE_BLOCK.get(), 1)
					 .requires(RerMaterials.SAPPHIRE_GEM, 9)
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SAPPHIRE_GEM.get(), 9)
					 .requires(RerMaterialsBlocks.SAPPHIRE_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.SAPPHIRE_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.SAPPHIRE_BOLT.get())
					 .define('B', RerMaterials.SAPPHIRE_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.SAPPHIRE_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.SAPPHIRE_ROD.get())
					 .define('B', RerMaterials.SAPPHIRE_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.SAPPHIRE_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.SAPPHIRE_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.SAPPHIRE_DOUBLE_GEM.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.SAPPHIRE_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SAPPHIRE_BOLT.get(), 2)
					 .requires(RerMaterials.SAPPHIRE_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SAPPHIRE_TINY_DUST.get(), 9)
					 .requires(RerMaterials.SAPPHIRE_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SAPPHIRE_DUST.get())
					 .requires(RerMaterials.SAPPHIRE_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SAPPHIRE_LARGE_PLATE.get())
					 .requires(RerMaterials.SAPPHIRE_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SAPPHIRE_CLUSTER.get())
					 .requires(RerMaterials.SAPPHIRE_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SAPPHIRE_GEM.get(), 1)
					 .requires(RerMaterials.SAPPHIRE_FRAGMENT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.SAPPHIRE_GEM))
					 .save(recipeOutput, "roprer:sapphire_gem_from_fragment");

		  oreSmelting(recipeOutput, SAPPHIRE_SMELTABLES, RecipeCategory.MISC, RerMaterials.SAPPHIRE_GEM.get(), 0.2f, 200, "sapphire");

		  oreBlasting(recipeOutput, SAPPHIRE_SMELTABLES, RecipeCategory.MISC, RerMaterials.SAPPHIRE_GEM.get(), 0.2f, 100, "sapphire");

		  List<ItemLike> DIMENSIONAL_SMELTABLES = List.of(
					 RerMaterials.DIMENSIONAL_CLUSTER_SHARD,
					 RerMaterialsBlocks.DIMENSIONAL_ORE,
					 RerMaterialsBlocks.NETHERRACK_DIMENSIONAL_ORE,
					 RerMaterialsBlocks.END_STONE_DIMENSIONAL_ORE,
					 RerMaterialsBlocks.DEEPSLATE_DIMENSIONAL_ORE,
					 RerMaterials.DIMENSIONAL_DUST);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIMENSIONAL_CLUSTER_SHARD.get(), 9)
					 .requires(RerMaterialsBlocks.DIMENSIONAL_CLUSTER_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.DIMENSIONAL_CLUSTER_BLOCK.get(), 1)
					 .requires(RerMaterials.DIMENSIONAL_CLUSTER_SHARD, 9)
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.DIMENSIONAL_BLOCK.get(), 1)
					 .requires(RerMaterials.DIMENSIONAL_GEM, 9)
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIMENSIONAL_GEM.get(), 9)
					 .requires(RerMaterialsBlocks.DIMENSIONAL_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.DIMENSIONAL_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.DIMENSIONAL_BOLT.get())
					 .define('B', RerMaterials.DIMENSIONAL_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.DIMENSIONAL_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.DIMENSIONAL_ROD.get())
					 .define('B', RerMaterials.DIMENSIONAL_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.DIMENSIONAL_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.DIMENSIONAL_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.DIMENSIONAL_DOUBLE_GEM.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.DIMENSIONAL_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIMENSIONAL_BOLT.get(), 2)
					 .requires(RerMaterials.DIMENSIONAL_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIMENSIONAL_TINY_DUST.get(), 9)
					 .requires(RerMaterials.DIMENSIONAL_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIMENSIONAL_DUST.get())
					 .requires(RerMaterials.DIMENSIONAL_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIMENSIONAL_LARGE_PLATE.get())
					 .requires(RerMaterials.DIMENSIONAL_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIMENSIONAL_CLUSTER.get())
					 .requires(RerMaterials.DIMENSIONAL_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIMENSIONAL_GEM.get(), 1)
					 .requires(RerMaterials.DIMENSIONAL_FRAGMENT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.DIMENSIONAL_GEM))
					 .save(recipeOutput, "roprer:dimensional_gem_from_fragment");

		  oreSmelting(recipeOutput, DIMENSIONAL_SMELTABLES, RecipeCategory.MISC, RerMaterials.DIMENSIONAL_GEM.get(), 0.2f, 200, "dimensional");
		  oreBlasting(recipeOutput, DIMENSIONAL_SMELTABLES, RecipeCategory.MISC, RerMaterials.DIMENSIONAL_GEM.get(), 0.2f, 100, "dimensional");

		  List<ItemLike> MOONSTONE_SMELTABLES = List.of(
					 RerMaterials.MOONSTONE_CLUSTER_SHARD,
					 RerMaterialsBlocks.MOONSTONE_ORE,
					 RerMaterialsBlocks.NETHERRACK_MOONSTONE_ORE,
					 RerMaterialsBlocks.END_STONE_MOONSTONE_ORE,
					 RerMaterialsBlocks.DEEPSLATE_MOONSTONE_ORE,
					 RerMaterials.MOONSTONE_DUST);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.MOONSTONE_CLUSTER_SHARD.get(), 9)
					 .requires(RerMaterialsBlocks.MOONSTONE_CLUSTER_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.MOONSTONE_CLUSTER_BLOCK.get(), 1)
					 .requires(RerMaterials.MOONSTONE_CLUSTER_SHARD, 9)
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.MOONSTONE_BLOCK.get(), 1)
					 .requires(RerMaterials.MOONSTONE_GEM, 9)
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.MOONSTONE_GEM.get(), 9)
					 .requires(RerMaterialsBlocks.MOONSTONE_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.MOONSTONE_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.MOONSTONE_BOLT.get())
					 .define('B', RerMaterials.MOONSTONE_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.MOONSTONE_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.MOONSTONE_ROD.get())
					 .define('B', RerMaterials.MOONSTONE_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.MOONSTONE_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.MOONSTONE_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.MOONSTONE_DOUBLE_GEM.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.MOONSTONE_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.MOONSTONE_BOLT.get(), 2)
					 .requires(RerMaterials.MOONSTONE_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.MOONSTONE_TINY_DUST.get(), 9)
					 .requires(RerMaterials.MOONSTONE_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.MOONSTONE_DUST.get())
					 .requires(RerMaterials.MOONSTONE_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.MOONSTONE_LARGE_PLATE.get())
					 .requires(RerMaterials.MOONSTONE_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.MOONSTONE_CLUSTER.get())
					 .requires(RerMaterials.MOONSTONE_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.MOONSTONE_GEM.get(), 1)
					 .requires(RerMaterials.MOONSTONE_FRAGMENT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.MOONSTONE_GEM))
					 .save(recipeOutput, "roprer:moonstone_gem_from_fragment");

		  oreSmelting(recipeOutput, MOONSTONE_SMELTABLES, RecipeCategory.MISC, RerMaterials.MOONSTONE_GEM.get(), 0.2f, 200, "moonstone");
		  oreBlasting(recipeOutput, MOONSTONE_SMELTABLES, RecipeCategory.MISC, RerMaterials.MOONSTONE_GEM.get(), 0.2f, 100, "moonstone");

		  List<ItemLike> PERIDOT_SMELTABLES = List.of(
					 RerMaterials.PERIDOT_CLUSTER_SHARD,
					 RerMaterialsBlocks.PERIDOT_ORE,
					 RerMaterialsBlocks.NETHERRACK_PERIDOT_ORE,
					 RerMaterialsBlocks.END_STONE_PERIDOT_ORE,
					 RerMaterialsBlocks.DEEPSLATE_PERIDOT_ORE,
					 RerMaterials.PERIDOT_DUST);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PERIDOT_CLUSTER_SHARD.get(), 9)
					 .requires(RerMaterialsBlocks.PERIDOT_CLUSTER_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.PERIDOT_CLUSTER_BLOCK.get(), 1)
					 .requires(RerMaterials.PERIDOT_CLUSTER_SHARD, 9)
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.PERIDOT_BLOCK.get(), 1)
					 .requires(RerMaterials.PERIDOT_GEM, 9)
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PERIDOT_GEM.get(), 9)
					 .requires(RerMaterialsBlocks.PERIDOT_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.PERIDOT_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.PERIDOT_BOLT.get())
					 .define('B', RerMaterials.PERIDOT_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.PERIDOT_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.PERIDOT_ROD.get())
					 .define('B', RerMaterials.PERIDOT_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.PERIDOT_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.PERIDOT_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.PERIDOT_DOUBLE_GEM.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.PERIDOT_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PERIDOT_BOLT.get(), 2)
					 .requires(RerMaterials.PERIDOT_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PERIDOT_TINY_DUST.get(), 9)
					 .requires(RerMaterials.PERIDOT_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PERIDOT_DUST.get())
					 .requires(RerMaterials.PERIDOT_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PERIDOT_LARGE_PLATE.get())
					 .requires(RerMaterials.PERIDOT_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PERIDOT_CLUSTER.get())
					 .requires(RerMaterials.PERIDOT_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PERIDOT_GEM.get(), 1)
					 .requires(RerMaterials.PERIDOT_FRAGMENT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.PERIDOT_GEM))
					 .save(recipeOutput, "roprer:peridot_gem_from_fragment");

		  oreSmelting(recipeOutput, PERIDOT_SMELTABLES, RecipeCategory.MISC, RerMaterials.PERIDOT_GEM.get(), 0.2f, 200, "peridot");
		  oreBlasting(recipeOutput, PERIDOT_SMELTABLES, RecipeCategory.MISC, RerMaterials.PERIDOT_GEM.get(), 0.2f, 100, "peridot");

		  List<ItemLike> PYROPE_SMELTABLES = List.of(
					 RerMaterials.PYROPE_CLUSTER_SHARD,
					 RerMaterialsBlocks.PYROPE_ORE,
					 RerMaterialsBlocks.NETHERRACK_PYROPE_ORE,
					 RerMaterialsBlocks.END_STONE_PYROPE_ORE,
					 RerMaterialsBlocks.DEEPSLATE_PYROPE_ORE,
					 RerMaterials.PYROPE_DUST);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PYROPE_CLUSTER_SHARD.get(), 9)
					 .requires(RerMaterialsBlocks.PYROPE_CLUSTER_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.PYROPE_CLUSTER_BLOCK.get(), 1)
					 .requires(RerMaterials.PYROPE_CLUSTER_SHARD, 9)
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.PYROPE_BLOCK.get(), 1)
					 .requires(RerMaterials.PYROPE_GEM, 9)
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PYROPE_GEM.get(), 9)
					 .requires(RerMaterialsBlocks.PYROPE_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.PYROPE_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.PYROPE_BOLT.get())
					 .define('B', RerMaterials.PYROPE_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.PYROPE_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.PYROPE_ROD.get())
					 .define('B', RerMaterials.PYROPE_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.PYROPE_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.PYROPE_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.PYROPE_DOUBLE_GEM.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.PYROPE_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PYROPE_BOLT.get(), 2)
					 .requires(RerMaterials.PYROPE_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PYROPE_TINY_DUST.get(), 9)
					 .requires(RerMaterials.PYROPE_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PYROPE_DUST.get())
					 .requires(RerMaterials.PYROPE_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PYROPE_LARGE_PLATE.get())
					 .requires(RerMaterials.PYROPE_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PYROPE_CLUSTER.get())
					 .requires(RerMaterials.PYROPE_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.PYROPE_GEM.get(), 1)
					 .requires(RerMaterials.PYROPE_FRAGMENT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.PYROPE_GEM))
					 .save(recipeOutput, "roprer:pyrope_gem_from_fragment");

		  oreSmelting(recipeOutput, PYROPE_SMELTABLES, RecipeCategory.MISC, RerMaterials.PYROPE_GEM.get(), 0.2f, 200, "pyrope");
		  oreBlasting(recipeOutput, PYROPE_SMELTABLES, RecipeCategory.MISC, RerMaterials.PYROPE_GEM.get(), 0.2f, 100, "pyrope");

		  List<ItemLike> DIOPSIDE_SMELTABLES = List.of(
					 RerMaterials.DIOPSIDE_CLUSTER_SHARD,
					 RerMaterialsBlocks.DIOPSIDE_ORE,
					 RerMaterialsBlocks.NETHERRACK_DIOPSIDE_ORE,
					 RerMaterialsBlocks.END_STONE_DIOPSIDE_ORE,
					 RerMaterialsBlocks.DEEPSLATE_DIOPSIDE_ORE,
					 RerMaterials.DIOPSIDE_DUST);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIOPSIDE_CLUSTER_SHARD.get(), 9)
					 .requires(RerMaterialsBlocks.DIOPSIDE_CLUSTER_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.DIOPSIDE_CLUSTER_BLOCK.get(), 1)
					 .requires(RerMaterials.DIOPSIDE_CLUSTER_SHARD, 9)
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.DIOPSIDE_BLOCK.get(), 1)
					 .requires(RerMaterials.DIOPSIDE_GEM, 9)
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIOPSIDE_GEM.get(), 9)
					 .requires(RerMaterialsBlocks.DIOPSIDE_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.DIOPSIDE_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.DIOPSIDE_BOLT.get())
					 .define('B', RerMaterials.DIOPSIDE_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.DIOPSIDE_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.DIOPSIDE_ROD.get())
					 .define('B', RerMaterials.DIOPSIDE_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.DIOPSIDE_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.DIOPSIDE_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.DIOPSIDE_DOUBLE_GEM.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.DIOPSIDE_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIOPSIDE_BOLT.get(), 2)
					 .requires(RerMaterials.DIOPSIDE_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIOPSIDE_TINY_DUST.get(), 9)
					 .requires(RerMaterials.DIOPSIDE_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIOPSIDE_DUST.get())
					 .requires(RerMaterials.DIOPSIDE_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIOPSIDE_LARGE_PLATE.get())
					 .requires(RerMaterials.DIOPSIDE_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIOPSIDE_CLUSTER.get())
					 .requires(RerMaterials.DIOPSIDE_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.DIOPSIDE_GEM.get(), 1)
					 .requires(RerMaterials.DIOPSIDE_FRAGMENT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.DIOPSIDE_GEM))
					 .save(recipeOutput, "roprer:diopside_gem_from_fragment");

		  oreSmelting(recipeOutput, DIOPSIDE_SMELTABLES, RecipeCategory.MISC, RerMaterials.DIOPSIDE_GEM.get(), 0.2f, 200, "diopside");

		  oreBlasting(recipeOutput, DIOPSIDE_SMELTABLES, RecipeCategory.MISC, RerMaterials.DIOPSIDE_GEM.get(), 0.2f, 100, "diopside");

		  List<ItemLike> SULFUR_SMELTABLES = List.of(
					 RerMaterials.SULFUR_CLUSTER_SHARD,
					 RerMaterialsBlocks.SULFUR_ORE,
					 RerMaterialsBlocks.NETHERRACK_SULFUR_ORE,
					 RerMaterialsBlocks.END_STONE_SULFUR_ORE,
					 RerMaterialsBlocks.DEEPSLATE_SULFUR_ORE,
					 RerMaterials.SULFUR_DUST);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SULFUR_CLUSTER_SHARD.get(), 9)
					 .requires(RerMaterialsBlocks.SULFUR_CLUSTER_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.SULFUR_CLUSTER_BLOCK.get(), 1)
					 .requires(RerMaterials.SULFUR_CLUSTER_SHARD, 9)
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.SULFUR_BLOCK.get(), 1)
					 .requires(RerMaterials.SULFUR_GEM, 9)
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SULFUR_GEM.get(), 9)
					 .requires(RerMaterialsBlocks.SULFUR_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.SULFUR_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.SULFUR_BOLT.get())
					 .define('B', RerMaterials.SULFUR_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.SULFUR_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.SULFUR_ROD.get())
					 .define('B', RerMaterials.SULFUR_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.SULFUR_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.SULFUR_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.SULFUR_DOUBLE_GEM.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.SULFUR_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SULFUR_BOLT.get(), 2)
					 .requires(RerMaterials.SULFUR_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SULFUR_TINY_DUST.get(), 9)
					 .requires(RerMaterials.SULFUR_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SULFUR_DUST.get())
					 .requires(RerMaterials.SULFUR_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SULFUR_LARGE_PLATE.get())
					 .requires(RerMaterials.SULFUR_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SULFUR_CLUSTER.get())
					 .requires(RerMaterials.SULFUR_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.SULFUR_GEM.get(), 1)
					 .requires(RerMaterials.SULFUR_FRAGMENT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.SULFUR_GEM))
					 .save(recipeOutput, "roprer:sulfur_gem_from_fragment");

		  oreSmelting(recipeOutput, SULFUR_SMELTABLES, RecipeCategory.MISC, RerMaterials.SULFUR_GEM.get(), 0.2f, 200, "sulfur");

		  oreBlasting(recipeOutput, SULFUR_SMELTABLES, RecipeCategory.MISC, RerMaterials.SULFUR_GEM.get(), 0.2f, 100, "sulfur");

		  List<ItemLike> RUBY_SMELTABLES = List.of(
					 RerMaterials.RUBY_CLUSTER_SHARD,
					 RerMaterialsBlocks.RUBY_ORE,
					 RerMaterialsBlocks.NETHERRACK_RUBY_ORE,
					 RerMaterialsBlocks.END_STONE_RUBY_ORE,
					 RerMaterialsBlocks.DEEPSLATE_RUBY_ORE,
					 RerMaterials.RUBY_DUST);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.RUBY_CLUSTER_SHARD.get(), 9)
					 .requires(RerMaterialsBlocks.RUBY_CLUSTER_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.RUBY_CLUSTER_BLOCK.get(), 1)
					 .requires(RerMaterials.RUBY_CLUSTER_SHARD, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.RUBY_BLOCK.get(), 1)
					 .requires(RerMaterials.RUBY_GEM, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.RUBY_GEM.get(), 9)
					 .requires(RerMaterialsBlocks.RUBY_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.RUBY_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.RUBY_BOLT.get())
					 .define('B', RerMaterials.RUBY_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.RUBY_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.RUBY_ROD.get())
					 .define('B', RerMaterials.RUBY_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.RUBY_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.RUBY_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.RUBY_DOUBLE_GEM.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.RUBY_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.RUBY_BOLT.get(), 2)
					 .requires(RerMaterials.RUBY_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.RUBY_TINY_DUST.get(), 9)
					 .requires(RerMaterials.RUBY_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.RUBY_DUST.get())
					 .requires(RerMaterials.RUBY_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.RUBY_LARGE_PLATE.get())
					 .requires(RerMaterials.RUBY_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.RUBY_CLUSTER.get())
					 .requires(RerMaterials.RUBY_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.RUBY_GEM.get(), 1)
					 .requires(RerMaterials.RUBY_FRAGMENT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.RUBY_GEM))
					 .save(recipeOutput, "roprer:ruby_gem_from_fragment");

		  oreSmelting(recipeOutput, RUBY_SMELTABLES, RecipeCategory.MISC, RerMaterials.RUBY_GEM.get(), 0.2f, 200, "ruby");

		  oreBlasting(recipeOutput, RUBY_SMELTABLES, RecipeCategory.MISC, RerMaterials.RUBY_GEM.get(), 0.2f, 100, "ruby");

		  List<ItemLike> POTASSIUM_NITRATE_SMELTABLES = List.of(
					 RerMaterials.POTASSIUM_NITRATE_CLUSTER_SHARD,
					 RerMaterialsBlocks.POTASSIUM_NITRATE_ORE,
					 RerMaterialsBlocks.NETHERRACK_POTASSIUM_NITRATE_ORE,
					 RerMaterialsBlocks.END_STONE_POTASSIUM_NITRATE_ORE,
					 RerMaterialsBlocks.DEEPSLATE_POTASSIUM_NITRATE_ORE,
					 RerMaterials.POTASSIUM_NITRATE_DUST);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_CLUSTER_SHARD.get(), 9)
					 .requires(RerMaterialsBlocks.POTASSIUM_NITRATE_CLUSTER_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.POTASSIUM_NITRATE_CLUSTER_BLOCK.get(), 1)
					 .requires(RerMaterials.POTASSIUM_NITRATE_CLUSTER_SHARD, 9)
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.POTASSIUM_NITRATE_BLOCK.get(), 1)
					 .requires(RerMaterials.POTASSIUM_NITRATE_GEM, 9)
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_GEM.get(), 9)
					 .requires(RerMaterialsBlocks.POTASSIUM_NITRATE_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.POTASSIUM_NITRATE_BOLT.get())
					 .define('B', RerMaterials.POTASSIUM_NITRATE_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.POTASSIUM_NITRATE_ROD.get())
					 .define('B', RerMaterials.POTASSIUM_NITRATE_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.POTASSIUM_NITRATE_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_DOUBLE_GEM.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.POTASSIUM_NITRATE_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_BOLT.get(), 2)
					 .requires(RerMaterials.POTASSIUM_NITRATE_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_TINY_DUST.get(), 9)
					 .requires(RerMaterials.POTASSIUM_NITRATE_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_DUST.get())
					 .requires(RerMaterials.POTASSIUM_NITRATE_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_LARGE_PLATE.get())
					 .requires(RerMaterials.POTASSIUM_NITRATE_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_CLUSTER.get())
					 .requires(RerMaterials.POTASSIUM_NITRATE_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_GEM.get(), 1)
					 .requires(RerMaterials.POTASSIUM_NITRATE_FRAGMENT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.POTASSIUM_NITRATE_GEM))
					 .save(recipeOutput, "roprer:potassium_nitrate_gem_from_fragment");

		  oreSmelting(recipeOutput, POTASSIUM_NITRATE_SMELTABLES, RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_GEM.get(), 0.2f, 200, "potassium_nitrate");

		  oreBlasting(recipeOutput, POTASSIUM_NITRATE_SMELTABLES, RecipeCategory.MISC, RerMaterials.POTASSIUM_NITRATE_GEM.get(), 0.2f, 100, "potassium_nitrate");

		  List<ItemLike> FLUORITE_SMELTABLES = List.of(
					 RerMaterials.FLUORITE_CLUSTER_SHARD,
					 RerMaterialsBlocks.FLUORITE_ORE,
					 RerMaterialsBlocks.NETHERRACK_FLUORITE_ORE,
					 RerMaterialsBlocks.END_STONE_FLUORITE_ORE,
					 RerMaterialsBlocks.DEEPSLATE_FLUORITE_ORE,
					 RerMaterials.FLUORITE_DUST);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.FLUORITE_CLUSTER_SHARD.get(), 9)
					 .requires(RerMaterialsBlocks.FLUORITE_CLUSTER_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.FLUORITE_CLUSTER_BLOCK.get(), 1)
					 .requires(RerMaterials.FLUORITE_CLUSTER_SHARD, 9)
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterialsBlocks.FLUORITE_BLOCK.get(), 1)
					 .requires(RerMaterials.FLUORITE_GEM, 9)
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.FLUORITE_GEM.get(), 9)
					 .requires(RerMaterialsBlocks.FLUORITE_BLOCK)
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.FLUORITE_GEAR.get())
					 .pattern(" A ")
					 .pattern("ABA")
					 .pattern(" A ")
					 .define('A', RerMaterials.FLUORITE_BOLT.get())
					 .define('B', RerMaterials.FLUORITE_RING.get())
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.FLUORITE_RING.get(), 2)
					 .pattern("BAB")
					 .pattern("A A")
					 .pattern("BAB")
					 .define('A', RerMaterials.FLUORITE_ROD.get())
					 .define('B', RerMaterials.FLUORITE_BOLT.get())
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.FLUORITE_ROD.get(), 2)
					 .pattern(" A ")
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.FLUORITE_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
					 .save(recipeOutput);

		  ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RerMaterials.FLUORITE_DOUBLE_GEM.get())
					 .pattern(" A ")
					 .pattern(" A ")
					 .define('A', RerMaterials.FLUORITE_GEM.get())
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
		  ...
		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.FLUORITE_BOLT.get(), 2)
					 .requires(RerMaterials.FLUORITE_ROD)
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.FLUORITE_TINY_DUST.get(), 9)
					 .requires(RerMaterials.FLUORITE_DUST)
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.FLUORITE_DUST.get())
					 .requires(RerMaterials.FLUORITE_TINY_DUST, 9)
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.FLUORITE_LARGE_PLATE.get())
					 .requires(RerMaterials.FLUORITE_PLATE, 4)
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.FLUORITE_CLUSTER.get())
					 .requires(RerMaterials.FLUORITE_CHUNK, 4)
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
					 .save(recipeOutput);

		  ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RerMaterials.FLUORITE_GEM.get(), 1)
					 .requires(RerMaterials.FLUORITE_FRAGMENT, 9)
					 .unlockedBy("has_raw", has(RerMaterials.FLUORITE_GEM))
					 .save(recipeOutput, "roprer:fluorite_gem_from_fragment");
